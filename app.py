...
- הטבלה כתובה מימין לשמאל. עמודה ראשונה מימין = מועד הפקדה, אחרונה משמאל = סה"כ
- סדר העמודות: מועד הפקדה | עבור חודש | משכורת | תגמולי עובד | תגמולי מעסיק | פיצויים | סה"כ
- חלץ כל שורה בנפרד — גם שורות עם סכומים קטנים כמו 38 ₪
- הסה"כ בשורת הסיכום חייב להתאים לסכום כל שורות ההפקדות
